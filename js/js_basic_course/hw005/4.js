...
// const arrayFilter = products.filter(item => 'photos' in item && item.photos.length !== 0);

const arrayFilter = products.filter(item => {
...
// const arraySort = products.sort((product1, product2) => product1.price - product2.price);

const arraySort = products.sort((product1, product2) => {
