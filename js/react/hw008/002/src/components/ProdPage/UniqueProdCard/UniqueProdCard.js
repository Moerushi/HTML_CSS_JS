...
export const UniqueProdCard = ({ colors, sizes, price, title, description, category }) => {
  ...
  const chosen = {color, size, quantity};
  console.log(chosen);
          ...
          <details className="product-description__product-options__item">
            ...
            <div className="product-description__product-options__choise">
              ...
              {colors.map((color, index) => (
                <label key={index} className="product-description__product-options__label" htmlFor={color.toLowerCase()}>
                  <input onChange={handleColorChange} className="option-input" type="radio" name="color" value={color}
            ...
            <div className="product-description__product-options__choise">
              {sizes.map((size,index) => (
                <label onChange={handleSizeChange} key={index} className="product-description__product-options__label" htmlFor={`${size.toLowerCase()}-size`}>
                  <input className="option-input" type="radio" name="size" value={size}
