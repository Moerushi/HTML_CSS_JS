...
export const UniqueProdCard = () => {
  return (
    <div class="product-description__box center">
    <div class="product-description">
      <h2 class="product-description__title">WOMEN COLLECTION</h2>
      <div class="product-description__topline"></div>
      <h2 class="product-description__product-name">MOSCHINO CHEAP AND CHIC</h2>
      <p class="product-description__product-text">Compellingly actualize fully researched processes before proactive
      ...
      <p class="product-description__product-price">$561</p>
      <div class="product-description__bottomline"></div>
      <div class="product-description__product-options">

        <details class="product-description__product-options__item">
          <summary class="product-description__product-options__summary">CHOOSE COLOR</summary>
          <div class="product-description__product-options__choise">
            <label class="product-description__product-options__label" for="black">
              <input class="option-input" type="radio" name="color" value="black"
                id="black"/>
              BLACK
            </label>
            <label for="grey" class="product-description__product-options__label">
              <input class="option-input" type="radio" name="color" value="grey"
                id="grey"/>
              GREY
            </label>
            <label for="blue" class="product-description__product-options__label">
              <input class="option-input" type="radio" name="color" value="blue"
                id="blue"/>
              BLUE
            </label>
            <label for="white" class="product-description__product-options__label">
              <input class="option-input" type="radio" name="color" value="white"
                id="white"/>
              WHITE
            </label>
          </div>
        ...
        <details class="product-description__product-options__item">
          <summary class="product-description__product-options__summary">CHOOSE SIZE</summary>

          <div class="product-description__product-options__choise">
            <label class="product-description__product-options__label" for="xs-size">
              <input class="option-input" type="radio" name="size" value="xs-size"
                id="xs-size"/>
              XS
            </label>
            <label for="s-size" class="product-description__product-options__label">
              <input class="option-input" type="radio" name="size" value="s-size"
                id="s-size"/>
              S
            </label>
            <label for="m-size" class="product-description__product-options__label">
              <input class="option-input" type="radio" name="size" value="m-size"
                id="m-size"/>
              M
            </label>
            <label for="l-size" class="product-description__product-options__label">
              <input class="option-input" type="radio" name="size" value="l-size"
                id="l-size"/>
              L
            </label>
          </div>
        ...
        <details class="product-description__product-options__item">
          <summary class="product-description__product-options__summary">QUANTITY</summary>

          <div class="product-description__product-options__choise">
            <label class="product-description__product-options__label" for="quantity">
              <input class="product-description__product-options__quantity" type="number" name="quantity" step="1"
      ...
      <a href="#">
        <div class="product-description__addtocart">
          ...
          <p class="product-description__addtocart__text">Add To Cart</p>
